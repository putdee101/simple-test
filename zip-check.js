  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        (_document$querySelect3 = document.querySelector('.practice-user-zip')) === null || _document$querySelect3 === void 0 ? void 0 : _document$querySelect3.addEventListener('click', eventMethod);
