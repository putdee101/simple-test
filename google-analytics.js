import { _ as _decorate, s, e, y, a as _taggedTemplateLiteral, b as e$1, c as _inherits, d as _createSuper, f as _createClass, g as _classCallCheck, h as _assertThisInitialized } from './query-assigned-elements-ea6b21ce.js';
  ...
  return {
    ...
    d: [{
      ...
      value: function firstUpdated() {
        ...
        // gaDiv.async = true;
        // gaDiv.src = "https://www.googletagmanager.com/gtag/js?id=G-QJCCTSLZYY&l=lillyDataLayer";
        // let gaDiv2 = document.createElement('script');
        // gaDiv2.innerHTML = `
        // window.lillyDataLayer = window.lillyDataLayer || [];
        // function gtag(){lillyDataLayer.push(arguments)};
        // gtag('js', new Date());
        ...
        var gaDiv = document.createElement('script');
        gaDiv.innerHTML = "\n    (function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':\nnew Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],\nj=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=\n'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);console.log(\"New GTAG Script Running\");\n})(window,document,'script','dataLayer','GTM-PXL5B34');\n    ";
      }
    }, {
      kind: "method",
      key: "someFunc",
