  ...
  return {
    ...
    d: [{
      ...
      value: function firstUpdated() {
        ...
        header.innerHTML = "\n        <style>\n            .imgWidth {\n                width: 8%;\n            }\n\n            @media only screen and (max-width: 768px) {\n                .imgWidth {\n                    width: 15%;\n                }\n            }\n        </style>\n        <div style=\"display: flex; justify-content: space-between; align-items: center;\">\n            <img src=\"https://images.ctfassets.net/di8r7bkyya77/40qWeEqaeKk9a82ZUzWbRQ/687371fe3a0511b4c010b326d3afa8b3/taltz-logo.svg\" class=\"imgWidth\">\n            <button style=\"display: inline-block; padding: calc(.5rem - 2px) calc(1.5rem - 2px); font-size: 1.125rem; font-weight: 700; line-height: 1.5rem; color: #212121; background-color: #f5f5f5; border: 2px solid transparent; border-radius: 4px; box-shadow: 0 2px 3px rgba(0,0,0,.2); transition: background-color .25s ease,color .25s ease;\" onclick=\"lillyDataLayer.push({'event': 'contact'});\"> Contact Us </button>\n        </div>\n        <hr>\n      ";
