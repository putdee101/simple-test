  ...
  return {
    ...
    d: [{
      ...
      value: function getMetaConfig() {
        return import('./google-analytics.config-6e5e8290.js').then(function (x) {
          return x.config;
        });
      }
    }, {
      ...
      value: function firstUpdated() {
        ...
        gaDiv.innerHTML = "\n    (function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':\n    new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],\n    j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=\n    'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);console.log(\"Latest GTM Script Running\");\n    })(window,document,'script','dataLayer',".concat(this.gtmId, ");\n    ");
        head.prepend(gaDiv);
      }
    }, {
      kind: "method",
