  ...
  return {
    ...
    d: [{
      ...
      value: function getMetaConfig() {
        return import('./footer.config-f92ef981.js').then(function (x) {
          return x.config;
        });
      }
    }, {
