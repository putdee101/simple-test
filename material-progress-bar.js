  ...
  return {
    ...
    d: [{
      ...
      value: function getMetaConfig() {
        return import('./material-progress-bar.config-539a871e.js').then(function (x) {
          return x.config;
        });
      }
    }, {
      ...
      value: function render() {
        ...
        return y(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    <style>\n        .progressStyle {\n            width: 50%;\n            margin-left: auto;\n            margin-right: auto;\n            height: 65px;\n        }\n\n        @media only screen and (max-width: 768px) {\n            .progressStyle {\n                width: 85%;\n                margin-left: auto;\n                margin-right: auto;\n                height: 65px;\n            }\n        }\n    </style>\n    <div class=\"progressStyle\">\n        <mwc-linear-progress progress=\"", "\" style=\"float: left; width: 30%; margin: 1%; height: 4px; border-radius: 2px;\"></mwc-linear-progress>\n        <mwc-linear-progress progress=\"", "\" style=\"float: left; width: 30%; margin: 1%; height: 4px; border-radius: 2px;\"></mwc-linear-progress>\n        <mwc-linear-progress progress=\"", "\" style=\"float: left; width: 30%; margin: 1%; height: 4px; border-radius: 2px;\"></mwc-linear-progress>\n    </div>\n    "])), value1, value2, value3);
      }
    }]
  };
}, s);
