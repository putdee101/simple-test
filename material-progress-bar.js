  ...
  return {
    ...
    d: [{
      ...
      value: function getMetaConfig() {
        return import('./material-progress-bar.config-95b27f5d.js').then(function (x) {
          return x.config;
        });
      }
    }, {
      ...
      value: function render() {
        ...
        return y(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["<mwc-linear-progress progress=\"", "\"></mwc-linear-progress>"])), this.value);
      }
    }]
  };
}, s);
