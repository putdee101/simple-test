  ...
  return {
    ...
    d: [{
      ...
      value: function getMetaConfig() {
        return import('./material-progress-bar.config-015085d3.js').then(function (x) {
          return x.config;
        });
      }
    }, {
      ...
      value: function render() {
        var value = this.value || 0.2;
        return y(_templateObject || (_templateObject = _taggedTemplateLiteral(["<mwc-linear-progress progress=\"", "\"></mwc-linear-progress>"])), value);
      }
    }]
  };
}, s);
