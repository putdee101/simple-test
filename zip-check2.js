    ...
    d: [{
      ...
      value: function render() {
        ...
        var eventMethod = function eventMethod() {
          console.log('yoyo');
          var city = document.querySelector('.practice-user-city input');
          var state = document.querySelector('.practice-user-state input');
          var zip = document.querySelector('.practice-user-zip input');
        ...
        (_document$querySelect = document.querySelector('.practice-user-city input')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.addEventListener('blur', eventMethod);
        (_document$querySelect2 = document.querySelector('.practice-user-state input')) === null || _document$querySelect2 === void 0 ? void 0 : _document$querySelect2.addEventListener('blur', eventMethod);
        (_document$querySelect3 = document.querySelector('.practice-user-zip input')) === null || _document$querySelect3 === void 0 ? void 0 : _document$querySelect3.addEventListener('blur', eventMethod);
