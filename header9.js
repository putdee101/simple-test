  ...
  return {
    ...
    d: [{
      ...
      value: function getMetaConfig() {
        return import('./header.config-857962ba.js').then(function (x) {
          return x.config;
        });
      }
    }, {
      ...
      value: function firstUpdated() {
        ...
        header.innerHTML = "\n        <style>\n            .imgWidth {\n                height: ".concat(parseInt(this.height.toString()), "px;\n                width: ").concat(parseInt(this.width.toString()), "px;\n                margin: 10px;\n            }\n        </style>\n        <div style=\"display: flex; justify-content: start; align-items: center;\">\n            <a href=\"").concat(this.imgRedirectUrl, "\"><img src=\"").concat(this.imgUrl, "\" class=\"imgWidth\"></a>\n        </div>\n        <hr>\n      ");
